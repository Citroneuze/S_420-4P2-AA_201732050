...
public class LapinBlancBleu extends Lapin {

    private Image imgAnimPersonnage = new Image("org/calma/ui/s_4204p2aa_201732050/TP4/bunny.png");
    public LapinBlancBleu(int caseX, int caseY, StrategieDeplacementLapin strategieDeplacement) throws SlickException {
